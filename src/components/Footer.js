  ...
  return (
    <React.Fragment>
      <Grid height='250px' TABheight='182px' margin='80px 0 0' TABmargin='64px 0 0' backgroundColor='#0E1013' padding='24px 20px' TABpadding='24px 20px 36px'>
        ...
        <Grid display='flex' justifyContent='space-between' width='fit-content' margin='16px 8px 0' TABmargin='12px 4px'>
          <Text fontSize='12px' color='#bdc1c6' cursor='default'>© 2021 Project Talk'bout</Text>
          <Text fontSize='12px' color='#bdc1c6' margin='0 24px' cursor='default'>All rights reserved.</Text>
        </Grid>
      </Grid>
    </React.Fragment>
  )
