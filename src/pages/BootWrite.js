    ...
    <React.Fragment>
      <Grid backgroundColor="gray" height="100vh" padding="15vh">
        <Grid backgroundColor="#fff" width="45vw" height="65vh" margin="auto">
          <WindowInner>
            <HeaderBox>
              <Button width="7%" _onClick={() => history.push('/boot/main')}>
                {' '}
                X{' '}
              </Button>
              <Text
              ...
              <Button width="7%" _onClick={() => addPost()}>
                {edit_mode ? '수정' : '등록'}
              </Button>
            </HeaderBox>
            ...
            <BodyBox>
              <Row>
                ...
                <input
                  type="text"
                  placeholder="부트캠프명을 입력해주세요"
                  defaultValue={edit_mode ? old_post.title : null}
                  ref={titleInput}
                ></input>
              </Row>
              <Row>
              ...
              <Row>
                <Key>부트캠프의 장점</Key>
                <textarea
                  placeholder="부트캠프의 장점을 입력해주세요"
                  defaultValue={edit_mode ? old_post.content : null}
                  ref={contentInput}
                  rows="7"
                  cols="50"
                  style={{ resize: 'none' }}
