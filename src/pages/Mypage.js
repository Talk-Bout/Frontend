        ...
        >
            ...
            <Grid height="40%">
              <ProfileInnerBox>
                ...
                <ProfileName>
                  ...
                  <Text p margin="1% 0 0 0" fontSize="1vh" color="#696969">
                    {' '}
                    닉네임 | sparta@gmail.com
                  </Text>
                </ProfileName>
                <ProfileEditButton>
                  <Button
          ...
          <Grid height="100%" width="74%" margin="0 0 0 1%">
            <Grid height="30%" margin="0 0 2% 0">
              <DetailHeader>
                <Text p lineHeight="7vh" margin="0" padding="0% 5%">
                  {' '}
                  내 북마크 <span> (5) </span>{' '}
                </Text>
              </DetailHeader>
              <Grid height="70%" display="flex" justify_content="space-evenly">
                <DetailCard>
                  <CardTitle>
                    <Text p margin="0" fontSize="0.3vh" fontWeight="bold">
                      리뷰제목
                    </Text>
                    <Text p fontSize="0.3vh" color="#E5E5E5">
                      2021.07.25
                    </Text>
                    <Text p margin="0" fontSize="0.3vh" fontWeight="bold">
                      장점
                  ...
                  <CardContent>
                    <Text p margin="0" fontSize="1vh">
                      온라인 부트캠프라서 공간적 제약이 없고 소득공유 결제
                      모델이 있어서 당장 자금...
                    </Text>
                    <Text p fontSize="0.5vh" color="#E5E5E5">
                      자유게시판
                    </Text>
                  </CardContent>
                </DetailCard>
